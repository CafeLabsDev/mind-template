...
8. **Links "Ver também"**: ao criar ou editar um nó, cheque se ele se relaciona com outro nó existente. Se sim, adicione um link cruzado nos dois arquivos (seção `## Ver também` no final, com link relativo). É isso que faz o vault funcionar como grafo, não como uma pilha de arquivos soltos.
